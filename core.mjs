...
export const MOVES = Object.freeze({
  jab:    {name:'左ジャブ',side:'L',kind:'straight',wind:4,cue:2.7,recover:2.2,cancel:2.7,reach:1.25,damage:4,cost:7},
  cross:  {name:'右ストレート',side:'R',kind:'straight',wind:6,cue:2,recover:3.1,cancel:3.5,reach:1.42,damage:11,cost:15},
  hookL:  {name:'左フック',side:'L',kind:'hook',wind:7.5,cue:2,recover:3.5,cancel:4.4,reach:1.12,damage:14,cost:18},
  hookR:  {name:'右フック',side:'R',kind:'hook',wind:7.8,cue:2,recover:3.7,cancel:4.5,reach:1.15,damage:15,cost:19},
...
export function tick(s,dt=STEP,{cpuEnabled=true}={}){
  ...
  for(const f of s.fighters){
    ...
    if(f.attack){const a=f.attack;a.t+=dt;
      if(!a.feint&&!a.hit&&a.t>=a.wind){a.t=a.wind;a.hit=true;contacts.push(f.id);}
    }
  }
