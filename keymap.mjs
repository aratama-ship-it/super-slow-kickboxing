export const KEY_BINDINGS=Object.freeze([
  ...
  Object.freeze({id:'guard.high',label:'前を守る',group:'守り',defaultCode:'Digit1',selector:'[data-guard="high"]',kind:'guard',value:'high'}),
  Object.freeze({id:'guard.shell',label:'側面を固める',group:'守り',defaultCode:'Digit2',selector:'[data-guard="shell"]',kind:'guard',value:'shell'}),
  Object.freeze({id:'guard.body',label:'胴を守る',group:'守り',defaultCode:'Digit3',selector:'[data-guard="body"]',kind:'guard',value:'body'}),
  Object.freeze({id:'guard.open',label:'構えを緩める',group:'守り',defaultCode:'Digit4',selector:'[data-guard="open"]',kind:'guard',value:'open'}),
