export const KEY_BINDINGS=Object.freeze([
  ...
  Object.freeze({id:'attack.upperL',label:'左アッパー',group:'パンチ',defaultCode:'KeyM',selector:'[data-attack="upperL"]',kind:'attack',value:'upperL'}),
  Object.freeze({id:'attack.upperR',label:'右アッパー',group:'パンチ',defaultCode:'Comma',selector:'[data-attack="upperR"]',kind:'attack',value:'upperR'}),
  Object.freeze({id:'defense.L.parry',label:'左手パーリング',group:'守り',defaultCode:'KeyH',selector:'[data-defense-side="L"][data-defense="parry"]',kind:'defense',side:'L',value:'parry'}),
  Object.freeze({id:'defense.R.parry',label:'右手パーリング',group:'守り',defaultCode:'KeyL',selector:'[data-defense-side="R"][data-defense="parry"]',kind:'defense',side:'R',value:'parry'}),
  Object.freeze({id:'defense.L.block',label:'左手ブロッキング',group:'守り',defaultCode:'KeyY',selector:'[data-defense-side="L"][data-defense="block"]',kind:'defense',side:'L',value:'block'}),
  Object.freeze({id:'defense.R.block',label:'右手ブロッキング',group:'守り',defaultCode:'KeyO',selector:'[data-defense-side="R"][data-defense="block"]',kind:'defense',side:'R',value:'block'}),
  Object.freeze({id:'defense.L.body',label:'左手お腹ブロッキング',group:'守り',defaultCode:'KeyN',selector:'[data-defense-side="L"][data-defense="body"]',kind:'defense',side:'L',value:'body'}),
  Object.freeze({id:'defense.R.body',label:'右手お腹ブロッキング',group:'守り',defaultCode:'Period',selector:'[data-defense-side="R"][data-defense="body"]',kind:'defense',side:'R',value:'body'}),
